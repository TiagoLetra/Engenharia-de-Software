...
public class QuestionsXmlImport {
    ...
    private QuestionDetailsDto importMultipleChoiceQuestion(Element questionElement) {
        ...
        for (Element optionElement : questionElement.getChild("options").getChildren("option")) {
            ...
            if(optionElement.getAttributeValue("relevance").equals("null") == false){
                relevance = Integer.valueOf(optionElement.getAttributeValue("relevance"));
                hasRelevance = true;
            }
            ...
            if(hasRelevance)optionDto.setRelevance(relevance);
