...
class ConcludeQuizTest extends SpockTest {
    ...
    def setup() {
        ...
        questionDetails.setMultipleSelection(true)           //NOVO
    ...
    def 'conclude quiz without conclusionDate, without answering'() {
        ...
        correctAnswerDto.getCorrectAnswerDetails().getCorrectOptionsIds().contains(optionOk.getId())    //NOVO
        correctAnswerDto.getCorrectAnswerDetails().getCorrectOptionsIds().contains(optionOk2.getId())    //NOVO
    }
    ...
    def 'conclude quiz with answer, before conclusionDate'() {
        ...
        multipleChoiceAnswerDto.setOptionsIds([optionOk.getId(),optionOk2.getId()])     //NOVO
        ...
        questionAnswer.getQuizQuestion() == quizQuestion
        quizQuestion.getQuestionAnswers().contains(questionAnswer)
        ((MultipleChoiceAnswer) questionAnswer.getAnswerDetails()).getOptions().contains(optionOk)      //NOVO
        ((MultipleChoiceAnswer) questionAnswer.getAnswerDetails()).getOptions().contains(optionOk2)     //NOVO
        optionOk.getQuestionAnswers().contains(questionAnswer.getAnswerDetails())
        optionOk2.getQuestionAnswers().contains(questionAnswer.getAnswerDetails())
        and: 'the return value is OK'
        correctAnswers.size() == 1
        def correctAnswerDto = correctAnswers.get(0)
        correctAnswerDto.getSequence() == 0
